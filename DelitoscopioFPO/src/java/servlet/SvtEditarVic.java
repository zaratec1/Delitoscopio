 ...
 * @author zaratec
 */
public class SvtEditarVic extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet SvtEditarVic</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet SvtEditarVic at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
...
//        processRequest(request, response);
        ...
        int id_vic = Integer.parseInt(request.getParameter("id_vic"));
        ...
        Victima v = new Victima(id_vic, doc_vic, ci_pas_vic, ape_vic, nom_vic, eda_vic, maymen, ema_vic, gen_vic, etn_vic, niv_eco_vic, niv_edu_vic, id_usu);
        VictimaCrud Editar = new VictimaCrud();

        try 
        {
            Editar.editarVictima(v);
            if ("".equals(Editar.getError()))
            {

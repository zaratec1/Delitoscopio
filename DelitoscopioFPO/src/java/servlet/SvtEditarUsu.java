 ...
 * @author zaratec
 */
public class SvtEditarUsu extends HttpServlet {
...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet SvtEditarUsu</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet SvtEditarUsu at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
    }
...
//        processRequest(request, response);
        ...
        System.out.println("CED:" + ci_usu);
        
        Usuario u = new Usuario(id_usu, ci_usu, ape_nom_usu, nic_usu, pas_usu, ema_usu);
        UsuarioCrud Editar = new UsuarioCrud();

        try 
        {
            Editar.editarUsuario(u);
